...
public class ExcelRowReader implements ItemStreamReader<Row> {
    ...
    private FileInputStream fileInputStream;//파일 열고 닫기
    private Workbook workbook;//엑셀 파일
    private Iterator<Row> rowCursor;//커서
    private int currentRowNumber;//읽은 위치
    private final String CURRENT_ROW_KEY = "current.row.number"; //어디까지 읽었는지 저장
